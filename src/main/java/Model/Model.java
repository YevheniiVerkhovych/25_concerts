...
public static List<Concert> dataBase = new ArrayList<>();
    ...
    public static void dataBaseFilling() throws ParseException {
     ...
     dataBase.add(new Concert("19 03 2019 10:00", Locations.KYIV,    1500, Genre.ROCK, Group.ACCEPT));
     ...
     dataBase.add(new Concert("25 03 2019 19:00", Locations.HARKOV,  900,  Genre.TECHNO, Group.BEEGEES));
